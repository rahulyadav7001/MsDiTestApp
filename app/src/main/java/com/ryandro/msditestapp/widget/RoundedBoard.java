...
import com.ryandro.msditestapp.appconstants.DisplayUtil;
...
public class RoundedBoard {
    ...
    static final int WIDTH = 6 * Emotion.MEDIUM_SIZE + 7 * AppConstant.HORIZONTAL_SPACING;
    ...
    static final float BOTTOM = AppConstant.HEIGHT_VIEW_REACTION - 130;

    static final float TOP = BOTTOM - HEIGHT;

    static final float BASE_LINE = TOP + Emotion.MEDIUM_SIZE + AppConstant.VERTICAL_SPACING;
